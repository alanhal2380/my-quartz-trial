---
title: Sample Solutions 3 with Creases  and List Callouts Removed
draft: 
tags:
---
## Parallelogram identity
1.  Compute $\mathbf{u} - \mathbf{v}$ and $\mathbf{u} + \mathbf{v}$ using the rules of vector addition 
...
2.  Compute norms using $|\mathbf{v}| = \sqrt{\mathbf{v} \cdot \mathbf{v}}$  
...
3.  Verify $|\mathbf{u} + \mathbf{v}|^2 + |\mathbf{u} - \mathbf{v}|^2 = 2|\mathbf{u}|^2 + 2|\mathbf{v}|^2$  
...
1.  Obtain formula $\theta = \cos^{-1}\left(\frac{\mathbf{u} \cdot \mathbf{v}}{|\mathbf{u}| |\mathbf{v}|}\right)$  
...
3.  Compute $\theta\approx 0.705\text{ rad}$  
...
1.  Sign of the dot product determines quality of the angle  
    - !! Cosine Angle Rule: $\mathbf{x} \cdot \mathbf{y} = |\mathbf{x}| |\mathbf{y}| \cos(\theta)$ 
...
3.  Evaluate signs of the dot products  
...
2. Find a vector $\mathbf{b}$ with head in $\mathbf{P}_2$ when tail is in $\mathbf{P}_1$.
    -  Choose $\mathbf{v}_1\in\mathbf{P}_1$ and $\mathbf{v}_2\in\mathbf{P}_2$.  
...
3.  Find the normal vectors, $\mathbf{n}_1$ to $\mathbf{P}_1$ and $\mathbf{n}_2$ to $\mathbf{P}_2$.  
...
4. !! The distance from $\mathbf{P}_1$ to $\mathbf{P}_2$ equals the scalar projection of $\mathbf{b}$ onto either plane’s normal vector. 
5.  Choose $\mathbf{n}_1$ and compute the scalar projection of $\mathbf{b}$ onto $\mathbf{n}_1$.  
...
4.  Combine all formulas into the parametric vector function $(x,y,z)=(16t,\;31t-20,\;-3t+20)$.  
...
5. !!! The angle between two planes equals the angle between their normal vectors.  
...
6.  Find the normal vectors, $\mathbf{n}_1$ to $\mathbf{P}_1$ and $\mathbf{n}_2$ to $\mathbf{P}_2$.  
...
7. !! Cosine Angle Rule: $\mathbf{n}_1 \cdot \mathbf{n}_2 = |\mathbf{n}_1| |\mathbf{n}_2| \cos(\theta)$.  
    - Rearrange: $$\cos(\theta) = \frac{\mathbf{n}_1 \cdot \mathbf{n}_2}{|\mathbf{n}_1| |\mathbf{n}_2|}$$
8.  Compute that $\theta\approx 96.52^\circ$.  
